              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blblackck">Get alerts when pickup is scheduled and completed</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="bg-[#7FB54C] text-black rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 mt-1">✓</div>
                  <div>
                    ...
                    <p className="text-blblackck">Request additional pickups or special services instantly</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="bg-[#7FB54C] text-black rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 mt-1">✓</div>
                  <div>
                    ...
                    <p className="text-blblackck">Message our team with questions or concerns</p>
                  </div>
                </div>
              </div>
